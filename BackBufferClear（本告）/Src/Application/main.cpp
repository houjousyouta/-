...
void Application::Execute()
{
	...
	while (1)
	{
		...
		D3D.WorkShaderManager().m_HD2DShader.BeginNoLighting();
		{
			...
			D3D.WorkDevContext()->PSSetShaderResources(0, 1, 
				TreeTex.WorkSRViewAddress());
			D3D.DrawVertices(D3D_PRIMITIVE_TOPOLOGY_TRIANGLESTRIP,
				4,&v,sizeof(Vertex));
		}
