...
void Application::Execute()
{
	...
	//空ロード
	KdModelData Sky_Model;
	Sky_Model.Load("Asset/Models/Sky/BlueSky.gltf");

	//キューブロード
	KdModelData Cube_Model;
	Cube_Model.Load("Asset/Models/Cube/Cube.gltf");

	//地面ロード
	KdModelData Terrain_Model;
	Terrain_Model.Load("Asset/Models/Terrain/Terrain.gltf");
	...
	Math::Matrix camMat =
		Math::Matrix::CreateTranslation(0.0f, 1.0f, -5.0f);
